...
const skills = [
  new SkillsWrapper('Programing Languages', [
    ...
    new ProgressWrapper('C++', 95),
    new ProgressWrapper('C#', 75),
    new ProgressWrapper('Javascript', 90),
    new ProgressWrapper('Typescript', 85),
    new ProgressWrapper('Kotlin', 80),
    new ProgressWrapper('Java', 85),
    new ProgressWrapper('Rust', 40),
    new ProgressWrapper('SQL', 80),
  ]),
  new SkillsWrapper('Frameworks', [
    new ProgressWrapper('Qt', 85),
    new ProgressWrapper('Angular', 75),
    new ProgressWrapper('nodejs', 65),
    new ProgressWrapper('Ruby on Rails', 60),
  ]),
  new SkillsWrapper('Languages', [
    new ProgressWrapper('German', 90),
    new ProgressWrapper('English', 75),
    new ProgressWrapper('Arabic', 100),
  ]),
];
